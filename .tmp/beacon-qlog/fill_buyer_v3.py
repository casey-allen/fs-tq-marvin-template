...
DATE="2026-06-12"
# (Category, Question, VDR, Priority, Basis from our VDR review)
rows=[
 ("Power - Interconnection & Studies",
  "Where does the Interconnection Agreement stand, and can you share the current draft or redline? Until it's executed, the 177 MW reads as an approved pathway rather than contracted capacity.",
  "2.2, 2.3","Highest",
  "CIM projects IA execution Q3 2026; no executed IA in the room."),
 ("Power - Interconnection & Studies",
  ...
  "2.2","Highest",
  "Direct conflict in the docs: SIS 39-mo-from-IA vs CIM 2027 ramp. Biggest open item from the review."),
 ("Power - Interconnection & Studies",
  "The CIM cites 177 MW while the SIS studies 176.6 MW continuous. Which figure carries into the IA and ESA, and would any increase trigger a NYISO restudy?",
  "2.2, 1.1","High",
  "Load figure differs between CIM and SIS Rev 6."),
 ("Power - Interconnection & Studies",
  ...
  "2.3","High",
  "FSA present; FS output absent. FSA text references ~150/180-day study and a high-level estimate."),
 ("Power - Interconnection & Studies",
  ...
  "2.2","Medium",
  "CIM claims 2N/redundant feeds (N-1 unconfirmed); SIS notes a POI change mid-study."),
 ...
 ("Power - Substation & Equipment",
  ...
  "2.1, 4.3","High",
  "PSEG-owns / buyer-builds split is ambiguous; design appears conceptual (ROMs only)."),
 ("Power - Substation & Equipment",
  ...
  "4.3","High",
  "Two divergent ROMs reviewed (Clune 3/2/26; Hunter Roberts 3/5/26)."),
 ("Power - Substation & Equipment",
  ...
  "4.3","High",
  "Hunter Roberts shows ~40-52 wk furnish + ~48-52 wk install; nothing ordered per the room."),
 ...
 ("Power - Commercial / ESA",
  ...
  "1.1","Highest",
  "No ESA in the room; CIM flags 177 MW as subject to the executed ESA (projected Q4 2026)."),
 ("Power - Commercial / ESA",
  "The SIS gives a non-binding $25.34M (+/-50%) utility-upgrade estimate. What's the bound figure, the LIPA/customer cost allocation, and the collateral/security the ESA will require (form, magnitude, timing)?",
  "2.2","High",
  "Upgrade cost is a wide non-binding band; collateral undisclosed."),
 ...
 ("Title, Liens & Encumbrances",
  ...
  "3.1","High",
  "Schedule B (Title No. 917082): OZK building loan + open Sunbelt mechanics lien."),
 ("Title, Liens & Encumbrances",
  ...
  "3.1, 3.2","High",
  "Numerous recorded LILCO/LIPA and Long Island Expressway easements in Schedule B."),
 ...
 ("IDA / PILOT / Incentives",
  ...
  "Not in VDR - request","High",
  "IDA appears only as a Schedule B exception; VDR has no IDA folder."),
 ...
 ("Land, Easements & Access",
  ...
  "3.1 - request instrument","High",
  "Conservation easement in Schedule B; net buildable acreage never quantified in the CIM."),
 ("Land, Easements & Access",
  ...
  "3.2","Medium",
  "LIE access-restriction takings in Schedule B; transformers are oversize loads."),
 ...
 ("Environmental & Aquifer",
  ...
  "5.1 - request wetlands/species","High",
  "Phase I is stale/pre-construction; CIM supplemental says wetlands delineation not done; species 'clearance' asserted with no standalone report."),
 ("Environmental & Aquifer",
  ...
  "1.1, 3.1","Medium",
  "CIM flags a 'hydrogeologic sensitive zone'; designation and constraints unconfirmed."),
 ...
 ("Geotech & Conversion",
  ...
  "5.2","High",
  "Geotech reviewed: Class D, no liquefaction, 2 tsf - sized for warehouses, not DC equipment."),
 ("Geotech & Conversion",
  "Beyond the substation, what's the remaining capex estimate to reach a true powered shell (MEP upgrades, fit-out interfaces), and the basis-of-design behind the 'low-incremental conversion' claim?",
  "2.1","High",
  "CIM markets 'low incremental capex' but only the substation is costed."),
 ...
 ("Zoning, Permitting & Air",
  ...
  "3.3","High",
  "Zoning memo (Certilman Balin) confirms the use but the DC change-of-use isn't yet filed."),
 ("Zoning, Permitting & Air",
  "What's the NYSDEC air-permit applicability for the ~78 backup generators in this severe-ozone-nonattainment area, and what generation architecture (diesel / fuel cell / BESS) does the basis of design assume?",
  "2.1","High",
  "CIM implies ~78 gensets (29/25/24); NYC-metro ozone nonattainment; air pathway unscoped."),

 ("Transaction & Process",
  "Confirm the sale process, bid deadline, diligence window, and target sign/close, and provide guidance on price expectations and deal structure.",
  "1.1","High",
  "Broad TD Securities sale; pre-LOI; no price or exclusivity disclosed."),
]
...
# relabel K header to reflect its use in this version
...
open('.tmp/beacon-qlog/buyer_log_v3.csv','w').write(o.getvalue())
print('WROTE xlsx + csv with', len(rows), 'review-driven questions')
